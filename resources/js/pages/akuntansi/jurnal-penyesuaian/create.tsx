            ...
            <div className="p-4 sm:px-6 lg:px-8">
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="rounded-lg border bg-white">
                        <div className="flex items-center justify border-b border-gray-200 px-6 py-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Isi informasi jurnal penyesuaian di bawah ini.</p>
                            </div>
                        </div>
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button type="button" variant="secondary" onClick={submitAndGoBack} disabled={processing || !isBalanced}>
                            {processing && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                            <Save className="mr-2 h-4 w-4" />
                            Simpan & Kembali
                        </Button>
