                    ...
                    <div className="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800">
                            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Laporan Perubahan Modal</h3>
                            </div>
                            <div className="p-6">
                                <div className="space-y-6">
                                    {/* Ringkasan Perubahan Modal */}
                                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <h4 className="font-semibold text-lg mb-4 text-gray-900 dark:text-gray-100">Ringkasan Perubahan Modal</h4>
                                        <div className="space-y-3">
                                            <div className="flex justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                                                <span>Saldo Awal Modal</span>
                                                <span className={`font-medium ${saldoAwalModal >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                                            ...
                                            <div className="flex justify-between py-3 border-t-2 border-gray-300 dark:border-gray-500 font-bold text-lg">
                                                <span>Saldo Akhir Modal</span>
                                                <span className={`${saldoAkhirModal >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                                    ...
                                    {detailModal && detailModal.length > 0 && (
                                        <div>
                                            <h4 className="font-semibold text-lg mb-4 text-gray-900 dark:text-gray-100">Detail Per Akun Modal</h4>
                                            <div className="overflow-x-auto">
                                                <Table>
                                                    ...
                                                    <TableBody>
                                                        {detailModal.map((detail, index) => (
                                                            <TableRow key={index}>
                                                                <TableCell className="font-medium font-mono text-sm">
                                                                    {detail.akun.kode_akun}
                                                                </TableCell>
                                                                <TableCell>{detail.akun.nama_akun}</TableCell>
                                                                <TableCell className={`text-right font-mono ${detail.saldo_awal >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                                                                    {formatCurrency(detail.saldo_awal)}
                                                                </TableCell>
                                                                <TableCell className={`text-right font-mono ${detail.mutasi >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                                                                    {detail.mutasi >= 0 ? '+' : ''}{formatCurrency(detail.mutasi)}
                                                                </TableCell>
                                                                <TableCell className={`text-right font-medium font-mono ${detail.saldo_akhir >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                                    ...
                                    <Alert>
                                        ...
                                        <AlertDescription>
                                            <strong>Informasi:</strong> Laporan perubahan modal menunjukkan perubahan modal pemilik 
                                            selama periode tertentu. Saldo akhir modal harus sama dengan nilai modal di neraca pada 
