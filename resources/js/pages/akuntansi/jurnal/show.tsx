...
export default function JurnalShow({ jurnal }: JurnalPageProps) {
    const handlePost = () => {
        if (confirm('Apakah Anda yakin ingin memposting jurnal ini? Jurnal yang sudah diposting tidak dapat diubah.')) {
    ...
    const handleReverse = () => {
        if (confirm('Apakah Anda yakin ingin membalik jurnal ini? Jurnal yang dibalik tidak dapat diubah lagi.')) {
