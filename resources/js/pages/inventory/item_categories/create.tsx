                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-2">
                            <div>
                                <Button variant="outline" size="sm" onClick={() => router.visit('/item-categories')} className="gap-2">
                            ...
                            <div>
                                ...
                                <CardDescription>Buat kategori baru untuk mengelompokkan barang inventory</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent>
