...
export default function CreateGiroTransaction() {
    const { bank_accounts, daftar_akun_giro, daftar_akun } = usePage<Props>().props;
                ...
                <form onSubmit={submit} className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Isi informasi lengkap transaksi giro
                                    </CardDescription>
                                </CardHeader>
                        ...
                        <div className="space-y-6">
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle>Catatan Giro</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <ul className="text-sm text-muted-foreground space-y-2">
                                        <li>• Giro akan tersimpan dengan status pending</li>
                                        <li>• Status dapat diubah menjadi cair atau tolak</li>
                                        <li>• Jurnal otomatis akan dibuat saat posting</li>
                                        <li>• Perhatikan tanggal jatuh tempo giro</li>
                                        <li>• Giro masuk menambah saldo bank</li>
                                        <li>• Giro keluar mengurangi saldo bank</li>
                                    </ul>
                                </CardContent>
                            </Card>
                        </div>
